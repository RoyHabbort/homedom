    ...
    <div class="content-width">
        ...
        <div class="white-block" ng-controller="billingCTRL">
            ...
            <div class="download-billing">
                <a href="/admin/loadBillingTable">Загрузить таблицу файлом</a>
            </div>
            ...
            <div class="billing-table-wrap">
                <div class="filter-search">
                    ...
                    <div class="search-row">
                        ...
                        <label> до :</label> <input class="search-date-max" ng-model="dateVisited.max" ng-change="filterVisited(dateVisited)">
                    </div>
                    <div class="search-row">
